...
class super_hero:
    ...
    def run_sh(self):
        ...
        while run:
            ...
            # displaying the images (cactus,dragon,gunman,flag) 
            ...
            # bringing fire and bullets back to the dragon and gun once reaches end of the screen
            if (fire_img_x == 0):
                fire_img_x = 1050
    ...
    #screen displayed when you win the game
    def win_screen(self):
        run = True
        while run:
            mixer.init()
            # background music when you win the game
